...
import com.t527.wav2vecdemo.deepspeech2.AwDeepSpeech2Jni;
...
public class DeepSpeech2TestActivity extends Activity {
    private static final String TAG = "DeepSpeech2Test";
    
    private IAwWav2VecJni deepspeech2Jni;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // NPU 초기화
        AwDeepSpeech2Jni.initNpu();
        
        deepspeech2Jni = new AwDeepSpeech2Jni();
        boolean initSuccess = deepspeech2Jni.init(this, Config.DEEPSPEECH2_MODEL_FILE);
        
        if (initSuccess) {
            Log.d(TAG, "DeepSpeech2 initialization success");
            resultTextView.setText("DeepSpeech2 Model Ready");
        } else {
            Log.e(TAG, "DeepSpeech2 initialization failed");
            resultTextView.setText("DeepSpeech2 initialization failed");
        }
    }
    ...
    private View createLayout() {
        ...
        // DeepSpeech2 test audio files
        String[] audioFiles = {
            "test.wav",
            "1188-133604-0010.flac.wav",
            "1188-133604-0025.flac.wav"
        };
        String[] buttonLabels = {
            "Test Audio 1",
            "LibriSpeech 0010",
        ...
        for (int i = 0; i < audioFiles.length; i++) {
            ...
            button.setOnClickListener(v -> testDeepSpeech2(audioFile));
    ...
    private void testDeepSpeech2(String audioFileName) {
        try {
            ...
            if (audioData != null) {
                ...
                // Process with DeepSpeech2
                Wav2VecResult result = deepspeech2Jni.process(audioData, audioData.length, 16000);
                ...
                Log.d(TAG, "DeepSpeech2 result: " + result.toString());
            } else {
                resultTextView.setText("Failed to load audio file");
            }
            
        } catch (Exception e) {
            Log.e(TAG, "DeepSpeech2 test error", e);
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (deepspeech2Jni != null) {
            deepspeech2Jni.release();
        }
        AwDeepSpeech2Jni.releaseNpu();
    }
}
