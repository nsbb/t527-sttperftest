...
/**
 * Citrinet NPU JNI Interface
 */
public class AwCitrinetJni implements IAwWav2VecJni {
    private static final String TAG = "AwCitrinetJni";

    static {
        System.loadLibrary("awcitrinet");
    }
    ...
    public boolean init(Context context, String assetPath) {
        ...
        File cacheModelFile = new File(cacheDir, "citrinet_model_cache.nb");
